"""dependencies.py — auth/authorisatie dependencies (centraal token + lokaal HS256)."""
...
from app.auth.security import (CENTRAL_PUBLIC_KEY, decode_access_token,
                               decode_central_token, token_alg)
...
def get_optional_user(
    ...
    Nodig voor de app-autorisatiecontrole: die moet publieke routes ongemoeid
    laten (die komen zonder token binnen) en alleen ingrijpen wanneer er wél een
    token is meegestuurd.
    """
